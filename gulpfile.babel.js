...
gulp.task('build:shared', ['clean-dist-shared', 'styles-shared', 'scripts-shared'], () => {
...
gulp.task('watch', () => {
	...
	// require("./server.js");
	// liveReload.listen();
	gulp.watch(HTML_PATH, ['html-shared']);
	gulp.watch(JS_PATH, ['scripts-shared']);
	gulp.watch(SCSS_PATH, ['styles-shared']);
	gulp.watch(IMG_PATH, ['images-shared'])
});
